Rails.application.routes.draw do
  ...
  get "/v1/contacts/:contact_id", to: "api/v1/contacts#show"
  ...
  post "/v1/users/search", to: "api/v1/users#search"
  ...
  post "/v1/users/:user_id/contacts", to: "api/v1/contacts#create"
  post "/v1/users/:user_id/contacts/search", to: "api/v1/contacts#search"
  ...
  delete "/v1/contacts/:contact_id", to: "api/v1/contacts#destroy"
